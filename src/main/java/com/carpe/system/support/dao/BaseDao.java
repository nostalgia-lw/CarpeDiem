...
public interface BaseDao<T> {
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> Pagination<T> findPagination(CharSequence queryString, Long pageIndex, Long pageSize, Object... params);
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> Pagination<T> findPagination(CharSequence queryString, Long pageIndex, Long pageSize, Map<String, Object> params);
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> Pagination<T> findPagination(CharSequence queryString, CharSequence countString, Long pageIndex, Long pageSize, Object... params);
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> Pagination<T> findPagination(CharSequence queryString, CharSequence countString, Long pageIndex, Long pageSize, Map<String, Object> params);
	 ...
	 */
	@SuppressWarnings("hiding")
	public <T> Pagination<T> findSqlPagination(final CharSequence queryString, final CharSequence countString, final Map<String, Object> params, Long pageIndex, Long pageSize);
