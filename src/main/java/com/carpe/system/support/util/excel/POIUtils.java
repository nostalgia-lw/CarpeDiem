package com.carpe.system.support.util.excel;
...
public class POIUtils {
     ...
     */
    @SuppressWarnings("rawtypes")
    public void exportToExcel(HttpServletResponse response, String fileName, List objs, Class clazz, String sheetName, int pageSize) {
        ...
        try {
            ...
            HSSFWorkbook workbook = handleDataToExcel(objs, clazz, sheetName == null ? fileName : sheetName, pageSize);
